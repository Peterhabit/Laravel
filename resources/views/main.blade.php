...
<body>
    <div class="container">  
	<!-- 부트스트랩.min.js에 정의된 container 선언-->
	<!-- container Bootstrap에서 화면의 동적영역을 지정하는 클래스.-->
				 ...
				 <ul class="navbar-nav me-auto mb-2 mb-lg-0">
					...
					<li class="nav-item dropdown">
						...
						@if(session()->get("rank")==1)
							...
							<li><a class="dropdown-item" href="{{route('member.index')}}">사용자</a></li>  {{--경로를 채워주는 소스--}}
						@endif
						</ul>
					</li>
